...
namespace TheGame
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            songState = true;
            countLevel = 0;
            musicPlayer = new SoundPlayer(Resources.pesna);
        ...
        private void newGame(int golemina1, int golemina2, int sekRemaining)
        {
            ...
            musicStop.Location = new Point(160, 1);
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (CharacterLocation != portalBlueLocation && covece.Visible == true)
            {
                plav.Visible = true;
            }
            if (CharacterLocation != portalOrangeLocation && covece.Visible == true)
            {
                portokalov.Visible = true;
            }
        }
        ...
        public void backToMenu()
        {
            ...
            musicStop.Location = new Point(777, 16);
            setVisibility();
            countLevel = 0;
            if (lista.Count > 0)
            {
